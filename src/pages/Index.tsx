...
const Index = () => {
  ...
  // NOTE: Sign-in is handled via the dedicated /auth page and AuthProvider.
  // The previous modal-based sign-in has been removed to avoid duplication.
  ...
  // Handle navigation state from Dashboard when editing a resume
  useEffect(() => {
    if (location.state?.resumeData) {
      console.log('📍 Received resume data from Dashboard:', location.state.resumeData);
      console.log('📍 Resume ID:', location.state.resumeId);
      setImportedData(location.state.resumeData);
      if (location.state.resumeId) {
        setSelectedResumeId(location.state.resumeId);
      }
      setShowBuilder(true);
      // Clear the state so it doesn't persist on navigation back
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm border border-white/30 px-6 py-3 rounded-full mb-8">
              <img src="tarp-logo.png" alt="VitaBuilder" className="w-6 h-6" />
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    "VitaBuilder helped me create a professional resume in under 15 minutes. The ATS optimization feature gave me confidence that my resume would actually be seen by recruiters."
                  </p>
                  <div className="flex items-center">
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-12">
              <div className="md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  <img src="tarp-logo.png" alt="VitaBuilder" className="h-10" />
                </div>
            ...
            <div className="border-t border-gray-800 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p className="text-gray-400 text-sm">
                  &copy; 2025 VitaBuilder. Where Resumes Take Off. All rights reserved.
                </p>
